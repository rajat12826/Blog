...
export default function BlogEditor() {
  ...
  const draftBlogs = filteredBlogs.filter(blog => blog.status === "savedraft");
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700 transition-colors duration-300">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">Your Blog Posts</h2>
              ...
              <div className="mb-8">
                ...
                >
                  ...
                  {showPublished ? <ChevronUp size={18} className="text-gray-700 dark:text-gray-300" /> : <ChevronDown size={18} className="text-gray-700 dark:text-gray-300" />}
                </div>
                      ...
                      publishedBlogs.map(blog => (
                        ...
                        >
                          <div className="flex justify-between items-start">
                            <h4 className="font-medium text-gray-900 dark:text-gray-100">{blog.title}</h4>
              ...
              <div>
                ...
                >
                  ...
                  {showDrafts ? <ChevronUp size={18} className="text-gray-700 dark:text-gray-300" /> : <ChevronDown size={18} className="text-gray-700 dark:text-gray-300" />}
                </div>
            ...
            <div className="lg:col-span-2 hidden lg:block">
              <div className="h-full w-full border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl p-12 text-center text-gray-400 dark:text-gray-500 transition-colors duration-300">
                Select a blog to preview or edit
              </div>
            </div>
          </div>
        </div>
